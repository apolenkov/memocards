...
class HomePresenterTest {
  ...
  void listDecks_filtersAndMaps() {
    ...
    StatsService stats =
        new StatsService(
            new org.apolenkov.application.infrastructure.repository.memory
                .InMemoryStatsRepository());
    FlashcardUseCase flashcardUseCase =
        new FlashcardUseCase() {
          @Override
          public java.util.List<org.apolenkov.application.model.Flashcard> getFlashcardsByDeckId(
              Long deckId) {
            return java.util.List.of();
          }

          @Override
          public java.util.Optional<org.apolenkov.application.model.Flashcard> getFlashcardById(
              Long id) {
