...
class LoginIT {
    ...
    void user_can_login_and_access_home() {
        ...
        org.assertj.core.api.Assertions.assertThat(login.getStatusCode().is3xxRedirection()).isTrue();

        ResponseEntity<String> home = rest.getForEntity("/home", String.class);
        org.assertj.core.api.Assertions.assertThat(home.getStatusCode().is2xxSuccessful()).isTrue();
    }
}
