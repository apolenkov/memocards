...
public class StatsDialogComponent extends Dialog {
  ...
  public StatsDialogComponent(
      DeckUseCase deckUseCase, UserUseCase userUseCase, StatsService statsService) {
    setWidth("760px");
    ...
    Span total =
        new Span(
            getTranslation(
                "stats.total", totalSessionsAll, totalViewedAll, totalCorrectAll, totalHardAll));
