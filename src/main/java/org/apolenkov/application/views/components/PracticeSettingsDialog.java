...
public class PracticeSettingsDialog extends Dialog {
    ...
    public PracticeSettingsDialog(PracticeSettingsService practiceSettingsService) {
        ...
        dirGroup.setValue(practiceSettingsService.getDefaultDirection() == org.apolenkov.application.model.PracticeDirection.FRONT_TO_BACK ? f2b : b2f);
        ...
        Button save = new Button(getTranslation("settings.save"), e -> {
            ...
            practiceSettingsService.setDefaultDirection(dirGroup.getValue().equals(f2b) ? org.apolenkov.application.model.PracticeDirection.FRONT_TO_BACK : org.apolenkov.application.model.PracticeDirection.BACK_TO_FRONT);
            close();
        });
