...
public class DataInitializer {
  ...
  CommandLineRunner initDemoData(
      UserRepository users, DeckRepository decks, FlashcardRepository cards) {
    return args -> {
      ...
      List<Flashcard> itCards =
          List.of(
              ...
              new Flashcard(
                  null, it.getId(), "Database", "База данных", "Organized collection of data"),
              new Flashcard(
                  null,
                  it.getId(),
                  "API",
              ...
              new Flashcard(
                  null, it.getId(), "Bug", "Ошибка в программе", "An error in a computer program"),
              new Flashcard(
                  null,
                  it.getId(),
                  "Version Control",
      ...
      List<Flashcard> englishCards =
          List.of(
              new Flashcard(null, english.getId(), "Apple", "Яблоко", "I eat an apple every day"),
              new Flashcard(
                  null, english.getId(), "Beautiful", "Красивый", "She has beautiful eyes"),
              new Flashcard(
                  null, english.getId(), "Computer", "Компьютер", "I work on my computer"),
